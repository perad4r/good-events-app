...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'vi_VN': {
      ...
      'remove_voucher': 'Xóa mã',
      'voucher_placeholder': 'VD: N1993+1...',
      'applied_code': 'Mã áp dụng',
      'used_voucher': 'Mã giảm giá đã dùng',
      'not_applicable': 'Không áp dụng',
      'voucher_validation_failed': 'Kiểm tra mã thất bại.',
      'remove_voucher_success': 'Đã xóa mã giảm giá.',
      'remove_voucher_failed': 'Xóa mã giảm giá thất bại.',
      ...
      'public_profile_no_video': 'Chưa có video giới thiệu.',
      ...
      'load_more_service_areas': 'Xem thêm khu vực',
      'search_service_area_to_remove': 'Tìm khu vực cần xóa',
      'no_matching_service_areas': 'Không tìm thấy khu vực phù hợp',
    ...
    'en_US': {
      ...
      'remove_voucher_success': 'Voucher removed.',
      'remove_voucher_failed': 'Failed to remove voucher.',
      ...
      'public_profile_no_video': 'No introduction video yet.',
      ...
      'load_more_service_areas': 'Load more areas',
      'search_service_area_to_remove': 'Search areas to remove',
      'no_matching_service_areas': 'No matching service areas',
      'clear_all': 'Clear all',
